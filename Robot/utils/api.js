...
const proxyApi = '/dataApi/';

const Verification= '/dataApi/webootApi/index/verification'; //获取验证码接口
export function getVerification(phone) {
  ...
  //return httpRequest.post(Verification,{ id: '111' }, {params: {username: '13411173567' , password: '13411173567'}} )
}

const Register= '/dataApi/webootApi/index/register'; //注册接口
...
const Auth= '/dataApi/webootApi/index/auth'; //登录接口
...
const MaterialList= proxyApi+'/webootApi/materialGroup/list'; //获取素材分组列表
